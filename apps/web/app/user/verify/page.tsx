...
export default function Verify() {
    ...
    const onSubmit = async (data: VerifyFormValues) => {
        try {
            ...
            const response = await axios.post("http://http-server.roomlocus.com/api/v1/user/verify-otp", {
                mobile: data.mobile,
                otp: data.otp,
            });
    ...
    const handleResendOTP = async (data: VerifyFormValues) => {
        try {
            ...
            const response = await axios.post("http://http-server.roomlocus.com/api/v1/user/resend-otp", {
                mobile: data.mobile,
            });
